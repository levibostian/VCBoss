...
Pod::Spec.new do |s|
  s.name             = 'VCBoss'
  s.version          = '0.1.0'
  s.summary          = 'A short description of VCBoss.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Levi Bostian/VCBoss'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Levi Bostian' => 'levi.bostian@gmail.com' }
  s.source           = { :git => 'https://github.com/Levi Bostian/VCBoss.git', :tag => s.version.to_s }
